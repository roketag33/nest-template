...
export class OauthController {
  ...
  @Get('google/callback')
  @UseGuards(AuthGuard('google'))
  async googleCallback(@Req() req: RequestWithOAuthUser, @Res() res: ExpressResponse) {
  ...
  @Get('github/callback')
  @UseGuards(AuthGuard('github'))
  async githubCallback(@Req() req: RequestWithOAuthUser, @Res() res: ExpressResponse) {
  ...
  @UseGuards(AuthGuard('facebook'))
  async facebookCallback(@Req() req: RequestWithOAuthUser, @Res() res: ExpressResponse) {
  ...
  @Get('apple/callback')
  @UseGuards(AuthGuard('apple'))
  async appleCallback(@Req() req: RequestWithOAuthUser, @Res() res: ExpressResponse) {
