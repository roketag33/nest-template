...
export class TwoFactorController {
  ...
  async verify(@Req() req: RequestWithUser, @Body('token') token: string) {
  ...
  async enable(@Req() req: RequestWithUser, @Body('token') token: string) {
  ...
  async disable(@Req() req: RequestWithUser, @Body('token') token: string) {
